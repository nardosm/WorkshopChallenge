    ...
    return (
      ...
      <Sidebar.Pushable>
          ...
          <Sidebar as={Container} animation='push' direction="left" width='thin' visible={visible} icon='labeled'  vertical page>
            ...
            <Checkbox  name="orig_mortg_sponsor_orig" onChange={this.handleInputChange}  label='Originating Mortgage Sponsor' />
            ...
            <Checkbox  name="endorsement_month" onChange={this.handleInputChange} label='Endorsement Month' />
        ...
        <BootstrapTable className=""  data={this.state.data} striped hover pagination search>
          ...
          <TableHeaderColumn hidden={this.state.orig_mortg_sponsor_orig}  dataField='orig_mortg_sponsor_orig' dataSort={true}>Originating Mortgage Sponsor</TableHeaderColumn>
          ...
          <TableHeaderColumn hidden={this.state.endorsement_month}  dataField='endorsement_month' dataSort={true}>Endorsement Month</TableHeaderColumn>
