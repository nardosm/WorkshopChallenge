    ...
    return (
      ...
      <Sidebar.Pushable >
           <Sidebar as={Menu} animation='scale down' direction="left" width='thin' visible={visible} icon='labeled'  vertical page>
            ...
            <Checkbox checked={!this.state.origination} name="origination" onChange={this.handleInputChange}  label='Originating Mortgage Sponsor' />
            ...
            <Checkbox checked={!this.state.mortgagee_sponsor_originator} name="mortgagee_sponsor_originator" onChange={this.handleInputChange} label='Endorsement Month' />
        ...
        <BootstrapTable className="page-padding"  data={this.state.data} striped hover pagination search>
          ...
          <TableHeaderColumn thStyle={ { whiteSpace: 'normal' } } hidden={this.state.origination}  dataField='origination' dataSort={true}>Originating Mortgage Sponsor</TableHeaderColumn>
          ...
          <TableHeaderColumn thStyle={ { whiteSpace: 'normal' } } hidden={this.state.mortgagee_sponsor_originator}  dataField='mortgagee_sponsor_originator' dataSort={true} dataSort={true}>Endorsement Month</TableHeaderColumn>
